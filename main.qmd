...
```{r}
need <- c("httr", "jsonlite", "magrittr", "readr", "openxlsx", "dplyr", "lubridate", "stringr", "purrr") # list packages needed
...
read_and_process <- function(file) {
  # Read columns C and D (date and value)
